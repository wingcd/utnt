...
namespace UTNT.HttpServer.Messages
{
    /// <summary>
    ...
    internal class Request : IRequest, IDisposable
    {
        ...
        private ILogger _logger = LogFactory.CreateLogger(typeof(Request));
        ...
        public ConnectionHeader Connection
        {
            get 
            {
                var header = Headers[ConnectionHeader.NAME];

                _logger.Debug("____name:" + ConnectionHeader.NAME + ", header:" + header.ToString());
