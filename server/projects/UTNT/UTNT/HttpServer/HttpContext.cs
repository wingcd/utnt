...
using UTNT.HttpServer.Messages;
using UTNT.HttpServer.Messages.Parser;
using UTNT.HttpServer.Tools;
using UTNT.HttpServer.Transports;

namespace UTNT.HttpServer
{
	/// <summary>
	/// A HTTP context
	/// </summary>
	...
	{
	    private static readonly ObjectPool<byte[]> Buffers = new ObjectPool<byte[]>(() => new byte[65536]);
